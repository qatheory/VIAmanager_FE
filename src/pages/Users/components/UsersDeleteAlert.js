...
export default function UserDeleteAlert(props) {
  ...
  let userDeleteDialogStatus = useSelector((state) => state.user.deleteDialog);
    ...
    >
      ...
      <DialogContent>
        <DialogContentText id="alert-dialog-description">
          Sau khi thực hiện xóa tài khoản, sẽ không có bất cứ cách nào có thể
          lấy lại được tài khoản đã bị xóa!
        </DialogContentText>
      </DialogContent>
      <DialogActions>
